...
from asr.google_transcription import AudioStream
...
class Test():
    ...
    """
    kind = "audio"
    def __init__(self: object, frequency: int = 440, sample_rate: int = 16000) -> None:
        super().__init__()
